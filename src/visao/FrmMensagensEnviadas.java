 ...
 * @author William
 */
public class FrmMensagensEnviadas extends javax.swing.JFrame {

    /**
     * Creates new form FrmMensagensEnviadas
     */
    public FrmMensagensEnviadas() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMensagensEnviadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMensagensEnviadas().setVisible(true);
            }
        });
    }
